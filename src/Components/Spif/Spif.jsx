        ...
        <Row>
          ...
          <Col xs={12} md={6} className="area__focus__content__text">
            ...
            <p className="spif__area__para mt-4">
              Every Indian parent strives to give their kids the best education
              to help them live their dreams. In pursuit of these dreams, many
              kids, (much to their dislike) are forced to stay away from their
              parents. And for some, if it isn’t the lure of a jet-set life,
              then the process of living their own lives, starting their own
              families and shouldering responsibilities makes them forget those
              who brought them up – leaving them to fend for themselves at a
              time when they need so much support!
            </p>
            ...
            <p className="spif__area__para">
              ...
              term. They soon realized that they had embarked on a journey of no
              return! The plight of our elders was palpable. “There is no
            ...
            <p className="spif__area__para">
              ...
              we care for our elders and in the way our elders live their golden
              years. The change we want: Every citizen is made aware of the
              importance of providing our elders with an environment in which
              they feel secure and safe as they age. We believe in the concept
              of “Happy Ageing” by making everyone, including our elders,
              understand why 65 to 80+ years are referred to as the “Golden
              Years” of life.
            </p>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col xs={12} md={6} className="area__focus__content__text">
            ...
            <ul className="ul__spif">
              ...
              <li>Technology is becoming a great challenge for our elders.</li>
              <li>
