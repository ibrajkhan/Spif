  ...
  return (
    <>
      <div className="area_focus_main">
        <Header />
        <div className="BackgroundImagesOurTeam">
          <h2>Our Team</h2>
        </div>
        ...
        <Container className="area__focus__content my-4">
          ...
          <Row className="mt-5">
            ...
            <Col md={8} className="area__focus__content__text">
              ...
              <p className="spif__area__para">
                ...
                His initiatives to remove regulatory barriers in availability of
                oral morphine for pain relief have contributed to simplification
                of narcotic regulations in 17 of India’s 29 states and more
                recently, to the amendment of the NDPS Act of India. His
                initiative has also contributed to the development of a
                Government policy on Palliative Care in the state of Kerala in
                2008 its revision in 2019, Government of India’s National
                Programme in Palliative Care (NPPC) in 2012, and the amendment
                of India’s Narcotic Act in 2014. In 2018, Dr Rajagopal was
          ...
          <Row className="mt-5">
            ...
            <Col md={8}>
              ...
              <p className="spif__area__para">
                ...
                implication of the term ‘service’.
              </p>
            </Col>
          </Row>
          ...
          <Row className="mt-5">
            <Col md={4} className="img_staff_content">
              <LazyLoadImage
                src={Sarthak}
                className="img-fluid staff_sec_img"
              />
            </Col>
