  ...
  return (
    <>
      <div className="area_focus_main">
        <Header />
        <div className="BackgroundImagesAreaFocus">
          <h2>Area Of Focus</h2>
        </div>
        <Container className="area__focus__content">
          <Row>
            ...
            <Col
              xs={12}
              md={6}
              className="area__focus__content__text"
              id="research">
              ...
              <p className="spif__area__para">
                2. Global best practices for elder care, especially from
                countries that excel.
              </p>
          ...
          <Row>
            <Col
              ...
              <p className="spif__area__para">
                ...
                aware of the problems they face collectively. In many instances,
                seniors are unaware of their rights and opportunities. As a
                foundation, we want to create positive changes by focusing on:
              </p>
              ...
              <p className="spif__area__para">
                2. Conduct campaigns to popularize “Happy Ageing” by educating
                the elderly about their “Golden Years” and encourage them to
                look forward to living their dreams, importance of vaccinations,
                etc
              </p>
        ...
        <Container className="area__focus__content">
          <Row>
            ...
            <Col
              ...
              <p className="spif__area__para">
                1. Offering retirees to re-engage in sync with their interest
                and energy.
              </p>
              <p className="spif__area__para">
          ...
          <Row>
            <Col xs={12} md={6} className="area__focus__content__text">
              ...
              <p className="spif__area__para">
                ...
                conducting surveys. As a result, we have already begun a survey
                on the challenges the elderly face. We have reached out to 700
                people from all walks of life. The survey respondents were
              ...
              <p className="spif__area__para">
                Seniors Go Digital Campaign When Covid hit, the first victims
                were the elderly, who lived alone without support. As a result
                of digital illiteracy, simple chores like buying groceries and
                paying bills became intimidating. By conducting a campaign, we
                taught the elderly how to use online payment methods to handle
                their everyday needs, communicate with family and friends, and
                so much more.
              </p>
              <p className="spif__area__para">
                ...
                the field of geriatrics, palliative care, and cardiology to
                share their thoughts on caring for elders and giving them the
                love and care they deserve. Real-life role models from the ages
                of 91-95 spoke to the attendees, shared their experiences about
                how they started their own business at the age of 85 and that
                their later years are truly the Golden Years. Over 400 people
